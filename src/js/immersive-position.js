...
class ImmersivePosion extends EventTarget {
  ...
  computeHtml() {
    const htmlTemplate = `
      ...
      <p>Département : ${this.data["LIMITES_ADMINISTRATIVES_EXPRESS.LATEST:departement"] ? this.data["LIMITES_ADMINISTRATIVES_EXPRESS.LATEST:departement"][0][0] : "chargement..."}</p>
