...
function beautifyLayerName(feature, source) {
    ...
    if (source == "poi_osm") {
        ...
        if (featureRule.length == 0) {
            if (feature.properties.hasOwnProperty('texte') && feature.properties.texte) legend.push(feature.properties.texte)
    ...
    // PLAN IGN
        ...
        if (feature.layer.hasOwnProperty("metadata") 
        && feature.layer.metadata.hasOwnProperty("legend-title"))
