...
class Search {
  ...
  computeAutocompResultHTML(autocompresult) {
    return `<p class="autocompresult" fulltext="${autocompresult.fulltext}" data-matomo-label="adresseRecherche" data-coordinates='{"lon":${autocompresult.lng},"lat":${autocompresult.lat}}'>
